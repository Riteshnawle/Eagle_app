      ...
      <div className="section-container py-16">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Industrial Corporate Pvt. Ltd</div>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Eaglehi-Tech Industrial Corporate Pvt. Ltd - Your trusted partner for workforce
              and industrial solutions across India.
            </p>
          </motion.div>
        ...
        <div className="border-t border-gray-700 py-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              <p>
                &copy; {currentYear} Eaglehi-Tech Industrial Corporate Pvt. Ltd. All rights reserved.
              </p>
            </motion.div>
          </div>
        </div>
